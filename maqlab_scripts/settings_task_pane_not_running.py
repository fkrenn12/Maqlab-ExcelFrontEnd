...
class WxMQTTSettingsPanel(wx.Panel):
    ...
    def __set_status(self, value):
        ...
        # else:
        #    self.label_status.SetBackgroundColour("green")
...
class Mqtt:
    ...
    async def connector(self):
        ...
        while True:
            ...
            while True:
                ...
                # if self.__event_connect.is_set():
                if self.__run:
                    break
            ...
            try:
                client.username_pw_set(username=self.__controller.username, password=self.__controller.password)
                client.connect_async(host=self.__controller.hostname, port=self.__controller.port)
                client.loop_start()
            except:
                pass
    ...
    async def main(self):
        self.__task = controller.loop.create_task(self.connector())
